...
#include "teleop_slave/ruckig_joint_trajectory_generator.hpp"
...
private:
    ...
    teleop_slave::RuckigJointTrajectoryGenerator ruckig_trajectory_generator_;
    bool ruckig_enabled_{false};
    JointArray ruckig_target_deg_{};
    bool ruckig_target_received_{false};
    JointArray joint_deadband_deg_{};
    JointArray joint_velocity_limit_deg_s_{};
    JointArray joint_acceleration_limit_deg_s2_{};
    JointArray joint_jerk_limit_deg_s3_{};
